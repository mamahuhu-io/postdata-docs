...
title: Develop
description: Learn how to contribute to Postdata.
---

We love your input! We want to make contributing to Postdata as easy and transparent as possible, whether it's:
...
[![Open in GitHub Codespaces](https://github.com/codespaces/badge.svg)](https://codespaces.new/mamahuhu-io/postdata)

[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/mamahuhu-io/postdata)
...
We use GitHub issues to track public bugs. Report a bug by [opening a new issue](https://github.com/mamahuhu-io/postdata/issues); it's that easy!
...
By contributing, you agree that your contributions will be licensed under [MIT License](https://github.com/mamahuhu-io/postdata/blob/main/LICENSE).
