...
title: Customization
description: Customize your Postdata experience.
---

You can access the customization settings by clicking on the "[**Settings**](https://postdata.cn/settings)" icon on the side panel.
