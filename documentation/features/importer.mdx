...
title: Importer
description: Migrate your data from other tools into Postdata.
---

Import data from other tools into Postdata. You can import data from the following tools:
...
<Note> The size limit for importing collections varies by Postdata edition. In **Postdata Cloud**, you can import collections up to **10 MB**, while **Self-Hosted editions** allow imports of up to **50 MB**. </Note>

## Import from Postdata

1. Export your Postdata collection/environment to a JSON file.
2. Open Postdata and click on the "**Import**" button on the collection/environment section.
3. Click on the "**Import from Postdata**" tab.
...
1. Open Postdata and click on the "**Import**" button on the collection section.
...
There are two ways to import OpenAPI collections into Postdata:

### 1. Import from File
1. Export your OpenAPI specification to a JSON file.
2. Open Postdata and click on the "**Import**" button on the collection section.
