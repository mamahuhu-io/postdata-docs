...
description: Configure client certificates for SSL authentication in Postdata.
---

Add and manage client certificates in [Postdata Desktop App](https://postdata.cn/download) to authenticate your identity when connecting to secure APIs.

### Prerequisites

Before you begin, ensure you have the following:

- Either the **Postdata Desktop App** installed on your system, or if you are using the Postdata Web App, make sure the **Postdata Agent** is installed and configured.
...
1. Open Postdata's settings page from the side bar.
