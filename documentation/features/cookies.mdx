...
<Info>Cookies support is only available in the [Postdata Desktop App](/documentation/clients/desktop).</Info>

Postdata Cookie Manager enables you to add, edit, and remove cookies for a domain. You can also send a cookie with a request.
...
When you send a request to a domain for which you've specified a cookie, Postdata will automatically include it as part of the request.
