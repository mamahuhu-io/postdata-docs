...
description: Learn how to create a request in Postdata.
---

The RESTful protocol is the default protocol that is active when you open Postdata. Postdata allows you to make API requests and examine the responses.
