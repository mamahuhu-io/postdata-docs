...
title: Introduction to Postdata
description: Open-source API development ecosystem.
---

Postdata is a lightweight, web-based API development suite. It was built from the ground up with ease of use and accessibility in mind providing all the functionality needed for developers with minimalist, unobtrusive UI.
...
<Steps>
  ...
  <Step iconType="light" icon="certificate" title="Cross-platform apps">
    Works on Mac, Windows, Linux, and CLI. No installation is required.
  </Step>
  <Step iconType="light" icon="server" title="Self-Host support">
    Host Postdata on your own server and use it with your team.
  </Step>
  ...
  <Step iconType="light" icon="layer-group" title="Built for developers">
    Have all your apis in one place and collaborate on your APIs with ease.
  </Step>
